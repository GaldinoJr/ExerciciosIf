...
public class ExerciciosFor {
    ...
    /**
     * 3 - Faça um programa que receba um numero final, execulte o for até esse número, concatene cada
     *número em uma string, e devolva essa string
     */

    /**
     * 4 - Faça um programa que conctene em uma string somente os numeros impares de 0 até 20,
     * e devolva essa string
     */

    /**
     * 5 - Faça um programa que conctene em uma string somente os numeros pares de 0 até 20,
     * e devolva essa string
     */
}
